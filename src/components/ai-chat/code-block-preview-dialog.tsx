  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        ...
        className="flex h-[calc(100dvh-2rem)] w-[calc(min(100vw-2rem,1024px))] max-h-none max-w-none flex-col gap-0 overflow-hidden p-0 sm:max-w-[min(70vw,1024px)] data-[state=closed]:animate-none data-[state=closed]:opacity-0"
      >
