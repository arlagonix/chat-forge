...
export function SettingsSidebar({
  ...
  return (
    <aside
      className="relative flex shrink-0 flex-col border-r bg-card/80"
      style={{ width }}
    >
      <div
      ...
      <div data-sidebar-titlebar className="app-region-drag select-none px-2 py-1">
        <div className="flex items-center justify-between gap-2">
          ...
          <h1 className="flex min-w-0 flex-1 items-baseline gap-1 truncate text-base font-semibold leading-6">
